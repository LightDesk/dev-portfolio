...
function Header() {
    return(
         <div >
             <div>
             <header className=" bg-white shadow-lg fixed w-full flex rounded text-xl justify-between lg:px-3 items-center">
            ...
            <div className=" text-center lg:text-left  lg:grid lg:grid-cols-4  lg:bg-white py-12" >
                ...
                <img className="max-w-xs rounded-full inline z-10 lg:mt-16 lg:ml-12 shadow-2xl lg:m-16 my-12" src={profile} alt="profile"></img>
                </div>
